...
const Admin = () => {
  ...
  const handleLogin = async () => {
    try {
      const response = await axios.post(buildApiUrl(API_CONFIG.authApiUrl, "/login"), formData);
  ...
  return (
    <div className="admin-container">
      ...
      {showLogin && (
        <div className="login-container">
          ...
          <p>
            ...
            <span className="register-link" onClick={() => navigate("/AdminRegister")}>
              Register
            </span>
          </p>
        </div>
      ...
      <div className="user-register-container">
        <button className="user-register-button" onClick={() => navigate("/UserRegister")}>
          User Register
        </button>
      </div>
    </div>
